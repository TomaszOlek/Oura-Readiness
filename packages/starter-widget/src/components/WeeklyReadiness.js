...
export default function WeeklyReadiness(props){
    ...
    useEffect(()=>{
        setChartData ([
            { 
                name: readyData[6] ? readyData[6].summary_date : "xx - xx - xxxx",
                value: readyData[6] ? readyData[6].score : 0 
            },
            { 
                name: readyData[5] ? readyData[5].summary_date : "xx - xx - xxxx", 
                value: readyData[5] ? readyData[5].score : 0 
            },
            { 
                name: readyData[4] ? readyData[4].summary_date : "xx - xx - xxxx", 
                value: readyData[4] ? readyData[4].score : 0 
            },
            { 
                name: readyData[3] ? readyData[3].summary_date : "xx - xx - xxxx", 
                value: readyData[3] ? readyData[3].score : 0 
            },
            {
                name: readyData[2] ? readyData[2].summary_date : "xx - xx - xxxx",
                value: readyData[2] ? readyData[2].score : 0 
            },
            { 
                name: readyData[1] ? readyData[1].summary_date : "xx - xx - xxxx",
                value: readyData[1] ? readyData[1].score : 0 
            },
            { 
                name: readyData[0] ? readyData[0].summary_date : "xx - xx - xxxx",
                value: readyData[0] ? readyData[0].score : 0 
            },
        ])
